namespace VtNetCore.VirtualTerminal
{
    ...
    public class VirtualTerminalController : IVirtualTerminalController
    {
        ...
        /// <summary>
        /// Emits raw text for script processing purposes. All formatting excluded.
        /// </summary>
        public EventHandler<TextEventArgs> OnRawText;
        ...
        public void Tab()
        {
            ...
            OnRawText?.Invoke(this, new TextEventArgs { Text = "\t" });
        ...
        public void CarriageReturn()
        {
            ...
            OnRawText?.Invoke(this, new TextEventArgs { Text = "\r" });
        ...
        public void PutChar(char character)
        {
            ...
            OnRawText?.Invoke(this, new TextEventArgs { Text = character.ToString() });
